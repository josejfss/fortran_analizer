...
public class TAST extends GramaticaBaseVisitor {

    public ControllerAST controllerAST = new ControllerAST();
    ...
    simbolo.setSimboloAST(controllerAST.generateRelation(izquierda,operacion,derecha));                 return simbolo;
                    ...
                    Simbolo simbolo = new Simbolo(TipoSimbolo.REAL, result);
                     ...
                     simbolo.setSimboloAST(controllerAST.generateRelation(izquierda,operacion,derecha));
                    return simbolo;
                }
            }
            case "/": {
   ...
   simbolo.setSimboloAST(controllerAST.generateRelation(izquierda,operacion,derecha));                  return simbolo;
    ...
    public Object visitParenExpr(GramaticaParser.ParenExprContext ctx) {
        Simbolo simbolo = (Simbolo) visit(ctx.expr());
        return simbolo;
    }
